...
Q_CONSTINIT static const qt_meta_stringdata_change_t qt_meta_stringdata_change = {
    {
        ...
        QT_MOC_LITERAL(51, 35),  // "on_dayComboBox1_currentIndexC..."
        QT_MOC_LITERAL(87, 5),  // "index"
        QT_MOC_LITERAL(93, 37),  // "on_monthComboBox1_currentInde..."
        QT_MOC_LITERAL(131, 28),  // "on_yearSpinBox1_valueChanged"
...
Q_CONSTINIT const QMetaObject change::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_change_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_yearSpinBox1_valueChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>
    >,
    nullptr
...
void change::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_dayComboBox1_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->on_monthComboBox1_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->on_yearSpinBox1_valueChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
