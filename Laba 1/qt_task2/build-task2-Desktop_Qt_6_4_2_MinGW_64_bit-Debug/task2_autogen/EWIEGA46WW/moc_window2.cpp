...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WIndow2_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WIndow2_t qt_meta_stringdata_WIndow2 = {
    {
        QT_MOC_LITERAL(0, 7)   // "WIndow2"
    },
    "WIndow2"
};
...
Q_CONSTINIT static const uint qt_meta_data_WIndow2[] = {
...
Q_CONSTINIT const QMetaObject WIndow2::staticMetaObject = { {
    ...
    qt_meta_stringdata_WIndow2.offsetsAndSizes,
    qt_meta_data_WIndow2,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_WIndow2_t,
        // Q_OBJECT / Q_GADGET
